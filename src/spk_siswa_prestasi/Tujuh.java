...
public class Tujuh extends javax.swing.JFrame {
    ...
    private void Tampilkan_Preferensi() {
        ...
        try {
            ...
            int no = 1;
            String sql = "SELECT tk.namasiswa,\n" +
"    (SQRT(\n" +
...
"    ) AS V;";
    ...
    private void initComponents() {
        ...
        setTitle("PERHITUNGAN KELIMA");
        setMinimumSize(new java.awt.Dimension(565, 605));
        ...
        jScrollPane2.setBounds(40, 280, 470, 280);

        jLabel2.setFont(new java.awt.Font("Rockwell Condensed", 1, 21)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 51));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Menghitung Hasil Preferensi");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(150, 230, 250, 25);
        ...
        jButton5.setBounds(30, 150, 109, 30);
        ...
        jLabel1.setText("Perhitungan Kelima");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(160, 10, 240, 34);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/bck_tujuh.jpg"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(-6, -6, 580, 610);
