...
"(K1/ x.ratio1) * bobotK1.bobotkriteria AS K1, \n" +
"(K2/ x.ratio2) * bobotK2.bobotkriteria AS K2, \n" +
"(K3/ x.ratio3) * bobotK3.bobotkriteria AS K3, \n" +
"(K4/ x.ratio4) * bobotK4.bobotkriteria AS K4, \n" +
"(K5/ x.ratio5) * bobotK5.bobotkriteria AS K5 FROM tabelkriteriasiswa AS tk\n" +
"JOIN (\n" +
"    SELECT \n" +
...
"JOIN (SELECT bobotkriteria FROM tabelkriteria WHERE idkriteria = 'K5') AS bobotK5;";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Perhitungan Matriks Keputusan Ternormalisasi Dan Terbobot");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(60, 210, 435, 20);
        ...
        jScrollPane1.setBounds(50, 240, 460, 352);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/bck_empat.jpg"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(-6, -6, 570, 620);
