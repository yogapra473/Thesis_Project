...
public class Enam extends javax.swing.JFrame {
    ...
    private void Tampilkan_DPlusMin() {
...
"            power(((tk.K5/ x.ratio5) * bobotK5.bobotkriteria) - V.K5max, 2)) AS DMax,\n" +
"       SQRT(\n" +
...
"            power(((tk.K5/ x.ratio5) * bobotK5.bobotkriteria) - V.K5min, 2)) AS DMin\n" +                    
...
"            MIN((tk.K4/ x.ratio5) * bobotK5.bobotkriteria) AS K5min\n" +                    
"        FROM tabelkriteriasiswa AS tk\n" +
"        JOIN (\n" +
"            SELECT \n" +
"    SQRT(SUM(power(K1,2))) as ratio1, \n" +
...
"    ) AS V;";
    ...
    private void initComponents() {
        ...
        setTitle("PERHITUNGAN KEEMPAT");
        setMinimumSize(new java.awt.Dimension(557, 630));
        setResizable(false);
        ...
        jScrollPane2.setBounds(50, 240, 440, 347);

        jLabel2.setFont(new java.awt.Font("Rockwell Condensed", 1, 21)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 51));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Menghitung Nilai D+ Dan D- Untuk Setiap Alternatif");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(40, 200, 450, 25);
        ...
        jButton8.setBounds(420, 140, 109, 30);
        ...
        jButton7.setBounds(290, 140, 109, 30);
        ...
        jButton6.setBounds(160, 140, 109, 30);
        ...
        jButton5.setBounds(30, 140, 109, 30);
        ...
        jLabel1.setText("Perhitungan Keempat");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(150, 10, 260, 34);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/bck_enam.jpg"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(-6, -6, 560, 610);
