...
public class Satu extends javax.swing.JFrame {
    ...
    private void Tampilkan_Data() {
        ...
        model.addColumn("Bobot Kriteria");

        try {

            int no = 1;
            String sql = "select namakriteria,bobotkriteria from tabelkriteria";
    ...
    private void initComponents() {
        ...
        btnback.setBounds(50, 30, 33, 23);

        jLabel1.setFont(new java.awt.Font("Rockwell Condensed", 1, 28)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("KRITERIA UTAMA");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(170, 20, 200, 34);
        ...
        jButton1.setBounds(20, 90, 109, 29);
        ...
        jButton2.setBounds(150, 90, 109, 29);
        ...
        jButton3.setBounds(280, 90, 109, 29);
        ...
        jButton4.setBounds(410, 90, 109, 29);
        ...
        jButton5.setBounds(20, 140, 109, 29);
        ...
        jButton6.setBounds(150, 140, 111, 29);
        ...
        jButton7.setBounds(280, 140, 109, 29);
        ...
        jButton8.setBounds(410, 140, 109, 29);

        jLabel2.setFont(new java.awt.Font("Rockwell Condensed", 1, 20)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 0, 51));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText(" Bobot Masing-Masing Kriteria");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(50, 190, 440, 24);
        ...
        jScrollPane1.setBounds(50, 230, 440, 180);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/bck_satu1.jpg"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(-6, -6, 550, 460);
